...
- ITZ (Institut für Technikzukünfte), working at the EU project SoMe4Dem (Social Media for Democracy)

- Passionate about R, data visualization, and social science methods

- Curious about how technology shapes democracy
...
| **Submission** |**R Markdown (.Rmd)** and the **HTML** file to the **GitHub repository** under the folder `submissions_wise25`. |
...
- Submit by **31st January 2026** on the Github Repo and by Email 
